# Design Basis & Open Issues Register — Rev.01

**Project:** Fully underground civil shelter, private plot, Rusanivski Sady,
Kyiv
**Document status:** Rev.01 — CONTROLLING DOCUMENT
**Prepared:** 13.09.2026
**Supersedes:** Nothing (first issue). This register itself now governs the
status of the earlier reference-concept package (PDF/XLSX/PNG/SVG) produced
in this session — see `RECLASSIFICATION_NOTICE.md`.

---

## 1. Purpose and effect of this register

This register records:

1. The **design basis** — what is known/assumed about the project, and on
   what authority (client brief vs. assumption vs. confirmed survey/test data).
2. The **open issues** — the specific inputs and calculations that are
...
retroactively to the reference-concept package generated earlier in this
session.

Only a licensed structural engineer (or a geotechnical/survey professional
for their respective disciplines) may close an item or issue a superseding
calculation, drawing, or quantity.

---

## 2. Design basis (as stated by the client — not yet confirmed by survey or test)

| # | Item | Value stated by client | Status |
|---|---|---|---|
| 1 | Location | Kyiv, Rusanivski Sady, private plot | Client statement — not surveyed |
| 2 | Occupancy | 4 persons | Client statement |
| 3 | Internal clear dimensions | 4000 × 3000 mm, clear height 2200 mm | Client-proposed, **not structurally verified** |
| 4 | Structural concept | Monolithic reinforced-concrete box | Client-proposed concept |
| 5 | Waterproofing concept | External membrane not feasible → "white box" (waterproof-concrete) concept | Client-proposed concept, **not confirmed by a waterproofing/structural engineer** |
| 6 | Concrete class (indicative only) | C35/45, W12, F200 | Client-proposed starting point, **not a design value** |
| 7 | Reinforcement class (indicative only) | A500C | Client-proposed starting point, **not a design value** |
| 8 | Entrance opening (indicative only) | 900 mm | Client-proposed, pending door supplier data (see Doc.04) |
| 9 | Emergency hatch (indicative only) | 800 × 800 mm | Client-proposed, pending supplier data (see Doc.04) |

All values in this section are **inputs to be tested**, not outputs to be
relied on. None of them, alone or combined, constitute a structural design.
...
inference, by re-running the earlier reference-concept calculations, or by
this or any other AI-generated output.
...
are closed by the responsible professionals:

- New or revised reinforcement quantities, bar schedules, or diameters
- New or revised concrete volumes or mix quantities
- New or revised budget/estimate figures
- New, revised, or re-issued KZh-numbered drawings
- Uplift (UPL), lateral earth pressure, slab, or reinforcement conclusions
